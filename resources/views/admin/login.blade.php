...
<body>
    <main>
        <div class="row">
            <div class="colm-logo">
                <img src="https://www.shutterstock.com/image-illustration/admin-sharp-text-written-on-260nw-1209613783.jpg"
                    alt="Logo">
            </div>
            <form action="" method="POST">
                @csrf

                <div class="colm-form form-group">
                    <div class="form-container">
                        ...
                        <span class="text-left" style="color: red;font-style: italic;font-size: 14px;">{{Session::get('no')}}</span>
                        @endif
                        <button class="btn-login btn" style="cursor: pointer;" type="submit">Login</button>
                        <a href="#">Forgotten password?</a>
                        <button class="btn-new" type="submit">Create new Account</button>
                    </div>
