...
@section('main')
         <!-- about-area-start -->
         <section class="about-area tpabout__inner-bg pt-175 pb-170 mb-50" data-background="assets/img/banner/about-bg-1.png" style="background-image: url(&quot;assets/img/banner/about-bg-1.png&quot;);">
            <div class="container">
               <div class="row">
                  <div class="col-lg-12">
         ...
         <section class="testimonial-area tptestimonial__bg pt-80 pb-55 p-relative">
            <div class="container">
               ...
               <div class="swiper-container tptestimonial-active3 p-relative swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                  <div class="swiper-wrapper" id="swiper-wrapper-64acbd9bb31491086" aria-live="off" style="transition-duration: 0ms; transform: translate3d(-2400px, 0px, 0px);"><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" role="group" aria-label="1 / 9" style="width: 450px; margin-right: 30px;">
                     ...
                     </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="1" role="group" aria-label="2 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
                     ...
                     </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="2" role="group" aria-label="3 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
                     ...
                     <div class="swiper-slide swiper-slide-duplicate-next" data-swiper-slide-index="0" role="group" aria-label="4 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
                     ...
                     <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="1" role="group" aria-label="5 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
                     ...
                     <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="2" role="group" aria-label="6 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
                  ...
                  <div class="swiper-slide swiper-slide-duplicate swiper-slide-next" data-swiper-slide-index="0" role="group" aria-label="7 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
                     ...
                     </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="1" role="group" aria-label="8 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
                     ...
                     </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="2" role="group" aria-label="9 / 9" style="width: 450px; margin-right: 30px;">
                        <div class="row justify-content-center p-relative">
                           <div class="col-md-12">
                              <div class="tptestimonial__item text-center mb-30">
                                 <div class="tptestimonial__avata mb-25">
